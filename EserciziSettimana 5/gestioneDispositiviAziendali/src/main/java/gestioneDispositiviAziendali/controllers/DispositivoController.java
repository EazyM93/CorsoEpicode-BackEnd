...
public class DispositivoController {
	...
	// ---------------------------------------------------------POST cambio stato dispositivo (id)
	@PutMapping("/{id_dispositivo}")
	public Dispositivo findAndUpdate(@PathVariable UUID id_dispositivo,
			@RequestBody ModificaStatoDispositivo bodyStato) throws Exception {
		
		return ds.findByIdAndUpdate(id_dispositivo, bodyStato)
